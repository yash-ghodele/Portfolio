...
export const metadata = {
    ...
    openGraph: {
        title: 'Sanjivani 2.0 - AI Crop Doctor | Yash Ghodele',
        description: 'Production-grade AI agriculture platform. Hybrid CNN+LLM architecture with edge optimization, multilingual support, and comprehensive testing.',
        url: 'https://yash-ghodele.pages.dev/work/sanjivani-v2',
        siteName: 'Yash Ghodele Portfolio',
        images: [{ url: '/images/projects/sanjivani-v2.jpg', width: 1200, height: 630, alt: 'Sanjivani 2.0 Platform' }],
        locale: 'en_US',
        type: 'article',
    },
    twitter: {
        ...
        images: ['/images/projects/sanjivani-v2.jpg'],
        creator: '@why_be_yashhh',
    },
    alternates: {
        canonical: 'https://yash-ghodele.pages.dev/work/sanjivani-v2',
    },
}
