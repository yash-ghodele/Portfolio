...
export const metadata = {
    ...
    openGraph: {
        title: 'Sanjivani - AI Crop Disease Detection | Yash Ghodele',
        description: 'An offline-capable PWA using Deep Learning (MobileNetV2) to detect crop diseases in under 2 seconds. Built for the 2G world.',
        url: 'https://yash-ghodele.pages.dev/work/sanjivani',
        siteName: 'Yash Ghodele Portfolio',
        images: [{ url: '/images/projects/agriculture-ai-crop-disease.jpg', width: 1200, height: 630, alt: 'Sanjivani AI App' }],
        locale: 'en_US',
        type: 'article',
    },
    twitter: {
        ...
        images: ['/images/projects/agriculture-ai-crop-disease.jpg'],
        creator: '@why_be_yashhh',
    },
    alternates: {
        canonical: 'https://yash-ghodele.pages.dev/work/sanjivani',
    },
}
