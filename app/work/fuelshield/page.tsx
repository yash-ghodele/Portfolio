...
export const metadata = {
    ...
    openGraph: {
        title: 'FuelShield - IoT Fuel Theft Detection | Yash Ghodele',
        description: 'Real-time fuel theft detection and fleet analytics platform. Reduces fuel losses by 20% using ESP32 sensors and MQTT.',
        url: 'https://yash-ghodele.pages.dev/work/fuelshield',
        siteName: 'Yash Ghodele Portfolio',
        images: [{ url: '/images/projects/fuel-monitoring-system.png', width: 1200, height: 630, alt: 'FuelShield IoT System' }],
        locale: 'en_US',
        type: 'article',
    },
    twitter: {
        ...
        images: ['/images/projects/fuel-monitoring-system.png'],
        creator: '@why_be_yashhh',
    },
    alternates: {
        canonical: 'https://yash-ghodele.pages.dev/work/fuelshield',
    },
}
