...
export const metadata = {
    ...
    openGraph: {
        ...
        url: 'https://yash-ghodele.pages.dev/work/iot-security',
        siteName: 'Yash Ghodele Portfolio',
        images: [{ url: '/images/projects/smart-lock-security-system.jpg', width: 1200, height: 630, alt: 'IoT Smart Lock System' }],
        locale: 'en_US',
        type: 'article',
    },
    twitter: {
        ...
        title: 'IoT Security - Smart Lock System | Yash Ghodele',
        description: '3-Layer Auth Smart Lock with autonomous lockdown and sub-300ms cloud latency.',
        images: ['/images/projects/smart-lock-security-system.jpg'],
        creator: '@why_be_yashhh',
    },
    alternates: {
        canonical: 'https://yash-ghodele.pages.dev/work/iot-security',
    },
}
