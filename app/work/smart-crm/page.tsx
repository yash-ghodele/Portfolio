...
export const metadata = {
    ...
    openGraph: {
        ...
        url: 'https://yash-ghodele.pages.dev/work/smart-crm',
        siteName: 'Yash Ghodele Portfolio',
        images: [{ url: '/images/projects/crm-business-management.jpg', width: 1200, height: 630, alt: 'Smart CRM Automation' }],
        locale: 'en_US',
        type: 'article',
    },
    twitter: {
        ...
        title: 'Smart CRM - Business Automation | Yash Ghodele',
        description: 'High-throughput VBA automation engine handling 100k+ B2B leads with 99.9% validation accuracy.',
        images: ['/images/projects/crm-business-management.jpg'],
        creator: '@why_be_yashhh',
    },
    alternates: {
        canonical: 'https://yash-ghodele.pages.dev/work/smart-crm',
    },
}
